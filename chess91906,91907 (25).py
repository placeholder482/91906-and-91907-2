...
class taking_piece:
    ...
    def take(self):
        ...
        check_black = [blackgrid for blackgrid in black_pieces_location_list.values()]
        temp_list1 = [""]
        temp_list2 = [""]  
        a = list(white_pieces_location_list.values())
        b = list(black_pieces_location_list.values())
        for x in a:
            print("a")
            temp_list1.append(x)
            print(F"1 = {temp_list1}")
            #print(set(temp_list1) == set(temp_list2))
                
        for c in b:
            #print(x)
            temp_list2.append(c)
            print(F"2 = {temp_list2}")
            #print(set(temp_list1) == set(temp_list2))
            
        for x in temp_list1:
            if x in set(temp_list2):
                print("yes2 true")
                break
