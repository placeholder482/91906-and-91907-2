...
class chess_board_piece_place:
    ...
    def placeholder_piece_press_function(self,piecetype,button_location):
        ...
        if self.move_check == [True,True]:
            ...
            button_holder = str(self.button_loc_holder[0])
            self.piece_move_holder.update({button_holder:piece_holder})
    ...
    def main_piece_place_function(self):
        ...
        if placing_white_or_black == 0:
            ...
            while piece_place_loop_count < len(self.piece_type_list):
                ...
                piece_place_var = Button(frame,text=self.piece_type_list[piece_place_loop_count],command=lambda piece_press_var = (piece_grid_loaction[0],piece_grid_loaction[1],piece_type,"white"):self.placeholder_piece_press_function(piecetype=piece_press_var,button_location=0),height=5,width=10)
            ...
            while pawn_loop_count < 8:
                    ...
                    piece_place_var_pawn = Button(frame,text="pawn",command=lambda piece_press_var = [piece_grid_loaction[0],piece_grid_loaction[1],"pawn","white"]:self.placeholder_piece_press_function(piecetype=piece_press_var,button_location=0),height=5,width=10)
            ...
            if piece_place_loop_count == len(self.piece_type_list):
                ...
                while piece_place_loop_count < len(self.piece_type_list):
                    ...
                    piece_type = self.piece_type_list[piece_place_loop_count]
                    piece_place_var = Button(frame,text=self.piece_type_list[piece_place_loop_count],command=lambda piece_press_var = (piece_grid_loaction[0],piece_grid_loaction[1],piece_type,"black"):self.placeholder_piece_press_function(piecetype=piece_press_var,button_location=0),height=5,width=10)
                ...
                while pawn_loop_count < 8:
                    ...
                    piece_place_var_pawn = Button(frame,text="pawn",command=lambda piece_press_var =[piece_grid_loaction[0],piece_grid_loaction[1],"pawn","black"]:self.placeholder_piece_press_function(piecetype=piece_press_var,button_location=0),height=5,width=10)
...
class piece_rules:
    ...
    def __init__(self,frame,piece_move_info,button_to_move):
        ...
        print(self.piece_type_transfer)
        print(f"piece type = {str(self.piece_type_transfer)}")
        ...
        print(f"piece function {self.piece_function_transfer}")
        ...
        if str(self.piece_type_transfer[2]) == "pawn":
            self.pawn_move_check_function(piece_type=self.piece_type_transfer[2],piece_move_loc=self.piece_function_transfer,piece_color=self.piece_type_transfer[3],move_to=button_to_move)    
    ...
    def pawn_move_check_function(self,piece_type,piece_move_loc,piece_color,move_to):
        piece_current_location = []
        piece_current_location.append(piece_move_loc[0])
        piece_current_location.append(piece_move_loc[1])
        print(f"piece current location {piece_current_location}")
