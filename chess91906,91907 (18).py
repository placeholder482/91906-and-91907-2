...
class piece_rules:
    ...
    def move_validity_check(self,move_start,move_end,diagonal,piecename):
        global move_valid
        move_valid = 0
        move_start_true = [move_start[0],move_start[1]]
        #move_valid = 1
        piece_locations = []
        row_change = False
        column_change = False
        ...
        if diagonal == 0:
            if row_change == True:
                ...
                print(f"check = {(current_row,current_column)}{(move_end[1],move_end[0])}")
                print(step_of_column,step_of_rows)
                a = [current_row,current_column]
                check = {([current_row,current_column]) == ([move_end[1],move_end[0]])}
                
                     
                #print((current_row,current_column) != (move_end[1],move_end[0]))
                if minus == False:
                        print(f"check = {piecename}")
                        rook_check = frame.nametowidget(piecename)
                        print()
                        if check == {True}:
                                print([move_end[1] -1,move_end[0]] in piece_locations)
                                print([move_start[1] +1,move_start[0]])
                                if [move_start[1] -move_end[1],move_start[0]] in piece_locations:
                                     move_valid = 0
                                     return
                                move_valid = 1
                                print('ab')
                        ...
                        while ([current_row,current_column]) != ([move_end[1],move_end[0]]):
                             ...
                             list_check = [current_row,current_column]
                ...
                if minus == True:
                     ...
                     return False
                             ...
                             #print(f"a = {(current_column,current_row - 1) }")
...
class file_saving:
    ...
    def game_save(self):
          for x in root.winfo_children():
               button_name = self.frame.nametowidget(x)
               print(button_name)


    def file_saving_gui(self,root):
          new_frame = Frame(root)
          save_button = Button(frame,text="save game",command=self.game_save(),width=100,height=100)
          save_button.lift()
          save_button.pack()
