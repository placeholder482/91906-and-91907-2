...
class taking_piece:
    ...
    def take(self):
        ...
        for x in white_pieces_dict.keys():
            print(f"white = {x}")
            white_piece_taking_widget = self.frame.nametowidget(x)
            transfer_grid_loc = white_piece_taking_widget.grid_info()
        
            piece_current_row = transfer_grid_loc['row']
            piece_current_column = transfer_grid_loc['column']
            location_append = [piece_current_row,piece_current_column]
            white_pieces_location_list[x] = (location_append)
        ...
        for x in black_pieces_dict.keys():
            ...
            piece_current_column = transfer_grid_loc['column']
            location_append = [piece_current_row,piece_current_column]
            black_pieces_location_list[x] = (location_append)
            print(f"black pieces list = {black_pieces_location_list}")
            
        for whitename,whitegrid in (white_pieces_location_list.items()):
            #print(f"a = {a}")
            print("")
        for blackname,blackgrid in (black_pieces_location_list.items()):
            print("")
                #print(f"b = {b}")
            if whitegrid == blackgrid:
                take = True
                print(f"match found at {whitename,blackname,take}")
