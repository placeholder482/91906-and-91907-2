...
class piece_rules:
    ...
    def bishop_move_check_function(self,piece_move_loc,move_to):
        ...
        while x < 10:
            ...
            if bishop_test == move_to:
                ...
                self.move_validity_check(move_start=bishop_list_loc_list.reverse(),move_end=move_to,diagonal=1)
    ...
    def rook_move_check_function(self,piece_move_loc,move_to):
        ...
        if piece_current_column == move_to[0]:
            self.move_validity_check(move_start=[piece_current_row,piece_current_column],move_end=move_to,diagonal=0)
    ...
    def move_validity_check(self,move_start,move_end,diagonal):
        ...
        for x in white_pieces_dict.values():
            print(x)
            piece_locations.append(x[0])
            print(f"piece location = {piece_locations}")
            print(f"x = {x}")
        for x in black_pieces_dict.values():
            print(x)
            piece_locations.append(x[0])
            print(f"piece location = {piece_locations}")
            print(f"x = {x}")
