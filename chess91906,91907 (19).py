...
class piece_rules:
    ...
    def move_validity_check(self,move_start,move_end,diagonal,piecename):
        ...
        step_of_rows = (row_diffrence >> 31) | (row_diffrence >> 0) if row_diffrence != 0 else 0
        step_of_column = (column_diffrence >> 31) | (column_diffrence >> 0) if column_diffrence != 0 else 0
        ...
        #piece_locations_true = piece_locations_true.remove(move_start)
        ...
        if diagonal == 0:
            if row_change == True:
                loop_ran = False
                print(f"check = {(current_column,current_row)}{(move_end[1],move_end[0])}")
            ...
            if column_change == True:
                while (current_row,current_column) != (move_end[1],move_end[0]):
                             ...
                             list_check = [current_column,current_row]
                             print(f"list check = {list_check}")
                             print(f"piece locations = {piece_locations_true}")
                             if list_check in piece_locations:
                                   move_valid = 0    
                                   print("asfaffd")
                                   return False
